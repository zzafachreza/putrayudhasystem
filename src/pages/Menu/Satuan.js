...
export default function ({ navigation, route }) {
    ...
    const __renderItem = ({ item }) => {
        return (
            ...
            <TouchableWithoutFeedback onPress={() => {
                navigation.navigate('SatuanDetail', item)
            }}>
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Icon type='ionicon' name='arrow-forward-circle' size={30} color={colors.secondary} />
                    </View>
    ...
    return (
        <SafeAreaView style={{
            ...
            <MyHeader judul="Profil Kantor" onPress={() => navigation.goBack()} />
